...
function HowItWork() {
  ...
  return (
    <div className='px-[100px] work-container flex min-h-[100px] mt-[150px]'>
      <div className="w-[40%] bg-[] h-[100%] work-left">
        <h2 className='text-[#A6A6A6]  font-[Inter] font-[800] text-[70px] '>How It Works</h2>
      </div>
      <div className="w-[60%] bg-[] work-box flex flex-col gap-[35px] h-[100%] right">
        ...
        <div className='bg-[#FFFFFF] py-[30px] work-2 px-[35px] border border-[1px] border-[#A6A6A6] rounded-[16px]'>
        ...
        <div className='bg-[#FFFFFF] py-[30px] work-3 px-[35px] border border-[1px] border-[#A6A6A6] rounded-[16px]'>
        ...
        <div className='bg-[#FFFFFF] py-[30px] work-4 px-[35px] border border-[1px] border-[#A6A6A6] rounded-[16px]'>
